 ...
 * Muestra todos los gastos disponibles para gestión
 *
...
export default function ListadoGastos(): JSX.Element {
	...
	const gastosFiltrados = useMemo(() => {
		if (!gastos) return [];
		return aplicarFiltrosComplejosAGastos(gastos, filtrosComplejos);
	}, [gastos, filtrosComplejos]);
	...
	// Memoizar la configuración de la tabla para evitar recreaciones innecesarias
	const table = useMaterialReactTable({
		...
		// Usar state en lugar de initialState para evitar resets automáticos
		initialState: {
	...
	if (isLoading) {
		return <Loader text="Cargando gastos..." />;
	}
	...
	return (
		<div className="p-3 sm:p-4 lg:p-6">
			...
			{/* Filtros complejos (rangos de fechas, montos, lógica de negocio) */}
